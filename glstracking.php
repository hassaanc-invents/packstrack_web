...
<head>
  ...
  <meta name="description" content=" GLS is one of the biggest companies in Europe that sends packages and other things quickly. It was started in late 1999, and in just a few years">
<meta name="keywords" content="TGLS Tracking, GLS Tracking Number, Tacking GLS, GLS Tracking Internazionale, Tracking Spedizione gls, GLS Italy Tracking">
...
<div class="rounded m-auto"><img src="<?php echo "uploaded_files/" . $imageLink; ?>" alt="GLS tracking" width="150" height="150px" class="img-fluid rounded-circle  border-dark mb-3 img-thumbnail shadow-sm">
